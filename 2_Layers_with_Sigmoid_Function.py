# -*- coding: utf-8 -*-
"""Back Propagation Homework.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1E6BoF8aPJtWWmtHuLewzNWrjF3BYxK0E

#Name: Pham Minh Long
#Student ID: 19119067
#Subject: AI: Foundations and Applications
#Credit: 3
#Lecturer: Assoc. Prof. PhD.Truong Ngoc Son

#1. Training Neural Network with Sigmoid Function(2 hidden layers)
"""
...
for ep in range (Epoch):
    ...
    plt.title("Training Neural Network with Sigmoid Function")
    plt.show()
    print('Epoch:', ep )
